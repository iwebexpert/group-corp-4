...
export const ONE_PAGE_PENDING = 'ONE_PAGE_PENDING'
export const ONE_PAGE_SUCCESS = 'ONE_PAGE_SUCCESS'
export const ONE_PAGE_ERROR = 'ONE_PAGE_ERROR'
...
export const onePagePending = () => ({
  type: ONE_PAGE_PENDING,
})
export const onePageSuccess = (data) => ({
  type: ONE_PAGE_SUCCESS,
  payload: data,
})
export const onePageError = (error) => ({
  type: ONE_PAGE_ERROR,
  payload: error,
})


export const onePageFetch = (url) => {
  return (dispatch) => {
    ...
    fetch(`/api/pages?url=${url}`, options)
      ...
      .then((result) => {
        ...
        console.log('resultonePAGE', result)
